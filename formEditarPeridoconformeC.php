        ...
        <!--Incrustar php-->
         ...
         <?php
                     $queryoficina = "SELECT ai.idDIM_Oficina as idDIM_OficinaII                      
                        ...
                        where cp.iddim_CPosterior='$iddim_CPosterior' and tpf.idTVerificacion='1'";
...
//recorriendo el conjunto de resultados con un bucle
            ...
            while ($filaoficina = $resultoficina->fetch_assoc()) {
                 ...
                 $query111="SELECT count(*) total FROM dim_epconforme p where p.iddim_aseguradoindevido='$iddim_CPosterior'";
