...
//
//$resultsql2 = $conexionmysql->query($query);
...
//        $eempleadora = utf8_decode($row2['RUC']);
        ...
        $query1 = "SELECT dr.iddim_CPosterior,
                            ai.autogenerado_t, ai.dni_t, ai.idDIM_Oficina,                      
                            dr.fconstanciaAcFirme,
                            dr.factofirme,
                            trr.idTRRBRegistro idTRRBRegistroCP,
                            trr.RRBRegistro RRBRegistroCP,
                            dr.nResBRegistro,
                            ...
                            FROM dim_cposterior dr
                            left join dim_aseguradoindevido ai on dr.iddim_CPosterior=ai.iddim_aseguradoindevido
                            left join tiporrbregistro trr on dr.idTRRBRegistro=trr.idTRRBRegistro
                            left join dim_reconsideracion rr on dr.iddim_CPosterior=rr.iddim_CPosterior
                            left join tiporrbregistro trrr on rr.idTRRBRegistro=trrr.idTRRBRegistro
                            where dr.iddim_CPosterior='$iddim_CPosterior'";
     ...
     <input id="i1" type="hidden" name="id" size="50" value="<?php echo $i ?>" readOnly="readOnly">  
                    ...
                    <tr>
                        ...
                        <?php if (is_null($fila['fechaReconsideracion'])) { ?>    
                            <td id="td1">   
                                <input type = "date" name = "fechaReconsideracion" id="fnotificacionBRegistro"
                                       min="1900-01-01">
                            </td>  
                            <?php
                        } else {
        ...
        <form name="form2" action="" method="POST" style="border: outset;">  
            <table id="t1" summary="Rellena Formulario" >
                ...
                <div class="input-group mb-3" style="width: 60%">
                    ...
                    <input class="custom-select" id="inputGroupSelect01" type = "date" name = "fechaReconsideracion_n" id="fechaReconsideracion_n"
...
<!--                <div class="input-group mb-3" style="width: 60%">
                ...
                <div class="input-group mb-3" style="width: 60%">
                    ...
                    <input class="custom-select" id="inputGroupSelect01" type = "date" name = "fechaReconsideracion_nm2" id="fechaReconsideracion_nm"
                           min="1900-01-01" value="">
                </div>-->
                ...
                while ($fila2 = $result1->fetch_assoc()) {
                    ...
                    <input id="i1" type="hidden" name="iddim_usuario" size="50" value="<?php echo $iddim_usuario ?>" readOnly="readOnly">  
                    <input id="i1" type="hidden" name="iddim_CPosterior" size="50" value="<?php echo $fila2['iddim_CPosterior'] ?>" readOnly="readOnly">  
                    <input type="hidden" name="nResBRegistro" id="nResBRegistro" value="<?php echo $fila2['nResBRegistro'] ?>" readonly="">
...
<?php if ($nuevo_oficna == $idOficinaUsuario) { ?>
                    ...
                    <div class="input-group mb-3" style="width: 60%">
                        <div class="input-group-prepend">
                            <button type= "submit" onclick="return confirm('Estás seguro que desea Registrar?');" name = "registrar" class="button button2">Registrar</button>
...
//            $nResBRegistro = $_POST['nResBRegistro'];
            ...
            if ($conexionmysql->query($query)) {           
                    ...
                    echo $iddim_Reconsideracion;
                    echo $fechaReconsideracion_n1;
                    echo $fechaReconsideracion_n2.'<br>';
                    echo $id;
                }           
            else {                
            }
        ...
        if (isset($_POST['registrar'])) {
            ...
            $iddim_CPosteriorr = $_POST['iddim_CPosterior'];
...
//            $fechaReconsideracion_n2 = $_POST['fechaReconsideracion_n2'];
            ...
            if($idTRRBRegistroREC_n==1) { 
                ...
                $query5 = "UPDATE dim_cposterior SET 
                ...
                $query3 = "INSERT INTO dim_reconsideracion (iddim_CPosterior, Resolucion, idTRRBRegistro, fechaReconsideracion, fechaReconsideracion1, fechaReconsideracion2, idtUsuario, fCreacion)                     
                            VALUES ($iddim_CPosterior, '$nResBRegistro', $idTRRBRegistroREC_n, '$fechaReconsideracion_n', $fechaReconsideracion_n1, $fechaReconsideracion_n2, $iddim_usuario, $fecha_hora_update)";  
