...
//            echo '<BR><BR>Bienvenido<br>' . utf8_decode($row['nombres']);
        ...
        <form action="" method="post" style="text-align: center" enctype="multipart/form-data" name="inscripcion">
            <label style="font-size: 18px;color: #0060C0;">SELECCIONAR ARCHIVO</label>
            ...
            <table>               
                ...
                <tr>
                    <td>
                        <label style="color: #0060C0;">Archivo:</label>
                    </td>  
                    <td>
                        <input style="background-color: #FFF288;color: #0060C0;"type="file" name="archivo[]" multiple="multiple" height="22px"><BR>
                    </td>                    
                </tr>
                <tr>
                    <td colspan="2">
                        <input class="button button2" type="submit" value="Enviar"  class="trig">
                    </td>
                </tr>   
                <tr style="text-align: left">
                    <td colspan="2" >   
                        <input type="checkbox" name="validar" value="1" required=""><label id="check_td" style="font-size: 10px;color: #0060C0;">Confirma que el Pdf contiene toda la informacion de la FIRME Y CONSENTIDA</label></input>
                    </td>
                </tr> 
            </table>            
        </form>
                ...
                if ($_FILES["archivo"]["type"][$i] == "application/pdf") {
                    ...
                    if (file_exists($carpetaDestino) || @mkdir($carpetaDestino)) {
                        ...
                        if (@move_uploaded_file($origen, $destino)) {
                            ...
                            $query = "UPDATE dim_cposterior SET validacion='$valida', ruta_pdf='/SISGASV/OSPES_SISGASV/OSPE_$oficina/PDF/$nombre_pdf', usuario_pdf='$idtusuario', dia_pdf=$fecha_hora_creacion WHERE iddim_CPosterior='$iddim_CPosterior'";
