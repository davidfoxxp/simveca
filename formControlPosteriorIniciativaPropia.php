        ...
        <div class="container" id="advanced-search-form">
            ...
            <form name="form" action="" method="POST" class="form-horizontal">   
                ...
                <div class="form-group">     
                    ...
                    <input type="text" class="form-control" id="ruc" name="ruc" readOnly  maxlength="11" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                </div>
                <div class="form-group">
...
//$conexion->close()               
                ...
                if ($dni != NULL) {
                    ?>
                        ...
                        <h2>REGISTRAR<br>
                    <label style="color: #F80000; font-size: 8px; display: contents">* CAMPOS OBLIGATORIOS</label></h2>

                    <div class="form-group">
                        <br/><label for="first-name">TIPO DE VERIFICACION<label style="color: #F80000; display: contents">*</label></label>          
                    ...
                    <!--///DESDE AQUI ES EL NO -->
                    <div class="form-group">
                        <br/><label for="last-name">GENERA BAJA REGISTRO<label style="color: #F80000; display: contents">*</label></label>
                    ...
                    <div class="form-group">
                        <br/><label for="last-name">ESTADO ACTUAL<label style="color: #F80000; display: contents">*</label></label>    
                    ...
                    ?>
                    <div class="form-group">
                        <label for="last-name">ORIGEN CONTROL POSTERIOR<label style="color: #F80000; display: contents">*</label></label>
                    ...
                    ?>
                    <div class="form-group">
                        <br/><label for="last-name">TIPO DE PERFIL<label style="color: #F80000; display: contents">*</label></label>
    ...
    <?php while ($row = $resultado->fetch_assoc()) { ?>
                    ...
                    <div class="form-group">
                        <label for="last-name" id="fechaemi" style="display: block">FECHA EMISION BAJA REGISTRO<label style="color: #F80000; display: contents">*</label></label>
                        <label for="last-name" id="fechaeva" style="display: none">FECHA CONFORMIDAD CONTROL POSTERIOR</label>
                        ...
                        <tr>
                            <td>  
                             <div class="form-group" style="width: 200px">
                                <label for="last-name">FECHA: PERIODO INICIO EVALUADO</label>
                                <input type="date" class="form-control date" name = "finicali" min="1998-01-01" max="<?php $hoy = getdate(); echo $hoy = date("Y-12-31"); ?>" 
                                       id="finicali" required></input>
                            </div>                      

                        </td>
                            <td>
                             <div class="form-group" style="width: 200px">
                                <label for="last-name">FECHA: PERIODO FIN EVALUADO</label>
                    ...
                    <table id="siesno" >
                        ...
                        <label for="first-name" id="th1">
                           Nº RESOLUCION DE BAJA DE REGISTRO (0000)<label style="color: #F80000; display: contents">*</label></label>
                        </label> 
                            ...
                            <td>
                    <div class="form-grouppp" style="width: 200px">
                        <label for="first-name" id="th1">DESPACHO QUE EMITIO RESOLUCION<label style="color: #F80000; display: contents">*</label></label>
                        ...
                        <tr>
                            <td>  
                                <div class="form-groupppp" style="width: 200px">
                                    <br/><label for="first-name">NIT</label><label style="color: #F80000">*</label>
                                    <input type="text" class="form-control"  name="nit" id="nit" maxlength="16" minlenth="11" onkeyup="this.value=SoloNumeroNit(this.value)"required></input> 
                                </div>
                            ...
                            <td>   
                             <div class="form-group" style="width: 200px">
                                ...
                                <input type="date" class="form-control date" name = "fnotificacionBRegistro" min="1998-01-01" max="<?php $hoy = getdate(); echo $hoy = date("Y-12-31"); ?>" 
                                       id="fnotificacionBRegistro"></input>
                            </div>
...
//            }
    ...
    $fecha_hora_update = "'$fecha_hora_updateo'";
     ...
     if ($unidad == 'NULL') { 
        ...
        if ($idTGeneraBRegistro == '1' && $idTEstadoActual == '1') {//////genera baja
        ...
        $query = "INSERT INTO dim_aseguradoindevido 
            ...
            casada_t, nombre1_t, fechanacimiento, DEPARTAMENT_t, PROVINCIA_t, DISTRITO_t, 
            DIRECCION_t, idTusuario ,fCreacion) 
            VALUES 
            ($max, '$idOficinaUsuario', $max, 
            '$ttrabajador', '1', '$tregistro', '$eempleadora', '$dni_eempleadora', 
            ...
            $query1 = "INSERT INTO dim_cposterior (iddim_CPosterior, idTVerificacion, idTVerificacionPerfil, origencp, iddim_aseguradoindevido, 
            idTEstadoActual, idTGeneraBaja, perfil_otros, observaciones, idtusuario,idtusuario_s, fCreacion)             
            VALUES ($max, $idTVerificacion, $idTVerificacionPerfil, $cbx_origencp, $max, 
            $idTEstadoActual, '$idTGeneraBRegistro', $perfil_otros, $obsOSPE,             
            $idtusuario, $idtusuario, $fecha_hora_creacion)";
            
            $query2 = "INSERT INTO dim_cfinanzas (iddim_CFinanzas, iddim_CPosterior, idtusuario, fCreacion) 
            values ($max, $max, $idtusuario, $fecha_hora_creacion)";       

//        $query3 = "INSERT INTO dim_pacalificar (iddim_PaCalificar, iddim_aseguradoindevido,
...
//               if ($conexionmysql->query($query3)) {
                    ...
                    echo 'Error al Actualizar registro: ', $nnnResBRegistro, '<br>';
    ...
    if ($idTGeneraBRegistro == '1' && $idTEstadoActual == '2') {///////// estado actual
        ...
        $query2 = "INSERT INTO dim_cfinanzas 
            (iddim_CFinanzas, iddim_CPosterior, idtusuario, fCreacion) 
            values ($max, $max,$idtusuario,$fecha_hora_creacion)";
...
//               if ($conexionmysql->query($query3)) {
    ...
    if ($idTGeneraBRegistro == '2') {//////genera baja
            ...
            $query1 = "INSERT INTO dim_cposterior 
            (iddim_CPosterior, idTVerificacion, idTVerificacionPerfil, origencp, iddim_aseguradoindevido, 
            idTEstadoActual, idTGeneraBaja, 
            perfil_otros,femisionBRegistro,observaciones,             
            idtusuario,idtusuario_s, fCreacion, fCreacionTerminado)             
            VALUES ($max, $idTVerificacion, $idTVerificacionPerfil, $cbx_origencp, $max, 
            '3', '2', $perfil_otros,$FEmisionBRegistro,$obsOSPE,             
        ...
        $query3 = "INSERT INTO dim_paevaluar_new 
            (iddim_aseguradoindevido, InicioPFinal,FinPFinal, idtusuario, fCreacion) 
            values ($max, $finicali,$ffincali,
