...
//alert(selected);
    ...
    <body>  
        ...
        $nombre_pdf_multa = $num_verifi . $dniait . $eempleadora . $cod_oficinaIni.$ano;
        ?> 
...
<!--                                <button onclick="myFunction22()"><i class="fas fa-copy"></i></button>-->
    ...
    ?>
                    ...
                    <tr>
                        <td id="tho" class="especial" style="width: 200px">
                            FECHA EMISION BAJA DE OFICIO <br> O FECHA DE ENVIO AL ARCHIVO
                        </td>                          

    <?php if (is_null($fila['fechaEmiBOficio'])) { ?>    
                            <td id="td1" colspan="2">
                                <input type = "date" name = "fechaEBO" min="1990-01-01" max="<?php $hoy = getdate(); echo $hoy = date("Y-12-31"); ?>"  id="fechaEBO" value="<?php echo $fila['fechaEmiBOficio'] ?>"><br>
                            </TD>
                            <?php
                        } else {
                            ?>
                            ...
                            <?php echo $fila['fechaEmiBOficio'] ?>
                                <input type = "HIDDEN" name = "fechaEBO" min="1990-01-01"id="fechaEBO" value="<?php echo $fila['fechaEmiBOficio'] ?>" readOnly><br>
                            </TD>
                                <?php
                            }
                            ?>
                    ...
                    <tr>
                        ...
                        <?php if (is_null($fila['fechaNAsegurado'])) { ?>    
                            <td id="td1" colspan="2">
                                <input type = "date" name = "fechaNAsegurado" min="1990-01-01" max="<?php $hoy = getdate(); echo $hoy = date("Y-12-31"); ?>"  id="fechaEBO" value="<?php echo $fila['fechaNAsegurado'] ?>"><br>
                            </TD>
                            <?php
                        } else {
                            ?>
                            ...
                            <?php echo $fila['fechaNAsegurado'] ?>
                                <input type = "HIDDEN" name = "fechaNAsegurado" min="1990-01-01" id="fechaEBO" value="<?php echo $fila['fechaNAsegurado'] ?>" readOnly><br>
                            <?php
                    ...
                    <tr>
                        ...
                        <?php if (is_null($fila['fechaNEmpleador'])) { ?>    
                            <td id="td1" colspan="2">
                                <input type = "date" name = "fechaNEmpleador" min="1990-01-01" max="<?php $hoy = getdate(); echo $hoy = date("Y-12-31"); ?>"  id="fechaEBO" value="<?php echo $fila['fechaNEmpleador'] ?>"><br>
                            </TD>
                            <?php
                        } else {
                            ?>
                            ...
                            <?php echo $fila['fechaNEmpleador'] ?>
                                <input type = "HIDDEN" name = "fechaNEmpleador" min="1990-01-01" id="fechaEBO" value="<?php echo $fila['fechaNEmpleador'] ?>" readOnly><br>
                            <?php
    ...
    ?>                                        
                ...
                <table id="t1" border="1" summary="Rellena Formulario">
                    ...
                    <tr>
                        <td id="tho" class="especial" style="width: 200px">
                            FECHA DE CONSTANCIA ACTO FIRME / RECONSIDERACION / APELACION
                        </td>                          

                        <?php if (is_null($fila['fechaActFirme'])) { ?>    
                            <td id="td1" colspan="2">
                                <input type = "date" name = "fechaActFirme" min="1990-01-01" max="<?php $hoy = getdate(); echo $hoy = date("Y-12-31"); ?>"  id="fechaEBO" value="<?php echo $fila['fechaActFirme'] ?>"><br>
                            </TD>
                            <?php
                        } else {
                            ?>
                            ...
                            <?php echo $fila['fechaActFirme'] ?>
                                <input type = "HIDDEN" name = "fechaActFirme" min="1990-01-01" id="fechaEBO" value="<?php echo $fila['fechaActFirme'] ?>" readOnly><br>
                            <?php
                    ...
                    <tr>
                        <td id="tho" class="especial" style="width: 200px">
                            FECHA DE ACTO FIRME <label style="color: #F80000">*</label>
                        </td>                          

                        <?php if (is_null($fila['factofirme'])) { ?>    
                            <td id="td1" colspan="2">
                                <input type = "date" name = "factofirme" min="1990-01-01" max="<?php $hoy = getdate(); echo $hoy = date("Y-12-31"); ?>"  id="fechaEBO" value="<?php echo $fila['factofirme'] ?>"><br>
                            </TD>
                            <?php
                        } else {
                            ?>
                            <td style="font-size: 12px" colspan="2" >
                            <?php echo $fila['factofirme'] ?>
                                <input type = "HIDDEN" name = "factofirme" min="1990-01-01" id="fechaEBO" value="<?php echo $fila['factofirme'] ?>" readOnly><br>
                            <?php
                                           $inicioooo = $fila['factofirme'];
                                           $finnnn = date("Y-m-d");

                                           function diferenciaDias4($inicioooo, $finnnn) {
                                               $iniciooo = strtotime($inicioooo);
                                               $finnn = strtotime($finnnn);
                                               $difff = $finnn - $iniciooo;
                                               $diasFalttt = (( ( $difff / 60 ) / 60 ) / 24);
                                               return ceil($diasFalttt);
                                           }
                                    ...
                                    <label>Dias de notificado</label>
                                    <?php
                                    echo diferenciaDias4($inicioooo, $finnnn)
                                    ?>
