...
//        $i = 10;
        while ($fila = $resultado->fetch_array()) {
            $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValueExplicit('AC' . $i, $fila['nombre_PDF_reso'], PHPExcel_Cell_DataType::TYPE_STRING)                    
     ...
     $estiloTituloColumnas6 = array(
      ...
      $estiloTituloColumnas7 = array(
       ...
       // $objPHPExcel->getActiveSheet()->getStyle('D2:E2')->applyFromArray($estiloTituloColumnas3);
        ...
        $objPHPExcel->getActiveSheet()->getStyle('M3:W3')->applyFromArray($estiloTituloColumnas1);
