...
//        order by cp.iddim_CPosterior asc";
     ...
     $consulta = "SELECT cp.iddim_CPosterior,
        ...
        where ai.idDIM_Oficina in ($idDIM_Oficina)
...
//        $i = 10;
       ...
       $estiloTituloColumnas = array(
        ...
        $objPHPExcel->getActiveSheet()->setTitle('DetallePendientesTotales');
...
//        $objPHPExcel->getActiveSheet(0)->freezePaneByColumnAndRow(0, 24);
        ...
        header('Content-Disposition: attachment;filename="DETALLE PENDIENTES TOTALES.xlsx"');
