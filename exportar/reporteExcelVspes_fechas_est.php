...
if (isset($_POST['buscar'])) {
    ...
    $cbx_estadoActual = $_POST['cbx_estadoActual']; //1
...
tea.EstadoActual
    ...
    if ($resultado->num_rows > 0) {
        ...
        $objPHPExcel->getProperties()->setCreator("Codedrinks") //Autor
                ...
                ->setDescription("Reporte por Tipo de Estado")
                ->setKeywords("Tipos de Estados")
                ->setCategory("Reporte excel");
          
        $tituloReporte = "RELACION DE VERIFICACIONES POR TIPO DE ESTADO DE LA OSPE ".$oficinano;
...
//        $objPHPExcel->getActiveSheet()->getStyle('A2:F2')->applyFromArray($estiloTituloReporte1);
        ...
        $objPHPExcel->getActiveSheet()->setTitle('POR TIPO ESTADO');
