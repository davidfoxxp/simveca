    ...
    $consulta=  "SELECT cp.iddim_CPosterior,
      ...
      case 
		...
		when cf.ncartafinanza1 IS NOT NULL then 'SI'  
                ...
                DATE_FORMAT(cf.fecartafinanza1, '%d/%m/%Y') fecartafinanza,
...
//                    ->setCellValue('L' . $i, $fila['TipoRegistro_des'])  
                    ...
                    ->setCellValueExplicit('S' . $i, $fila['nombrePDF'], PHPExcel_Cell_DataType::TYPE_STRING)
                    ->setCellValue('T' . $i, $fila['prestaciones'])
                    ->setCellValue('U' . $i, $fila['ncartafinanza1'])                    
//                    ->setCellValue('V' . $i, $fila['SUNAT_S'])  
...
//        $objPHPExcel->getActiveSheet()->getStyle('U3:V3')->applyFromArray($estiloTituloColumnas4);
        $objPHPExcel->getActiveSheet()->getStyle('M1:Y1')->applyFromArray($estiloTituloColumnas3);
//        $objPHPExcel->getActiveSheet()->getStyle('Y3:AD3')->applyFromArray($estiloTituloColumnas7);
//        $objPHPExcel->getActiveSheet()->getStyle('Z1:Y1')->applyFromArray($estiloTituloColumnas5);
//        $objPHPExcel->getActiveSheet()->getStyle('AC3:AE3')->applyFromArray($estiloTituloColumnas7);
        ...
        header('Content-Disposition: attachment;filename="Reporte_CP_FirmesyConsentidas_Act_SDH.xlsx"');
