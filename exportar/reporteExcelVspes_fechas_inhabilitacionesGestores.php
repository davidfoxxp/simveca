...
//        
//        $tituloReporte = "RELACION DE RESOLUCIONES DE INHABILITACIONES DE LA OSPE";
...
//            'FECHA DE'.PHP_EOL.'NACIMIENTO-'.PHP_EOL.'ASEGURADO'.PHP_EOL.'(dd/mm/yyyy)',
            'PERIODO INICIO'.PHP_EOL.'INHABILITACION'.PHP_EOL.'ASEGURADO O'.PHP_EOL.'EMPLEADOR'.PHP_EOL.'(FECHA)',
            'PERIODO FIN'.PHP_EOL.'INHABILITACION'.PHP_EOL.'ASEGURADO O'.PHP_EOL.'EMPLEADOR'.PHP_EOL.'(FECHA)',
            'CARTA DE INICIO'.PHP_EOL.'DEL PROCED'.PHP_EOL.'SANCIONADOR'.PHP_EOL.'(FECHA)',
            'INFORME FINAL'.PHP_EOL.'DE INSTRUCCION'.PHP_EOL.'(FECHA)',
