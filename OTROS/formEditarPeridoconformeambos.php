        ...
        <!--Incrustar php-->
         ...
         <?php
                     $queryoficina = "SELECT ai.idDIM_Oficina as idDIM_OficinaII                      
                        ...
                        where cp.iddim_Verificacion='$iddim_Verificacion' and tpf.idTVerificacion='2'";
...
//                  }
       ...
       ///////////////////////////////////////////CONTROL POSTERIOR
        ...
        <h5>Se actualizara bajo su responsabilidad.
         ...
         <?php
                 $query111="SELECT * FROM dim_epconforme p where p.iddim_aseguradoindevido='$iddim_CPosterior'";
                 $resultado = $conexionmysql->query($query111);
//                 $query112="SELECT * FROM dim_aseguradoindevido p where p.iddim_aseguradoindevido='$iddim_CPosterior'";
//                 $resultado2 = $conexionmysql->query($query112);
