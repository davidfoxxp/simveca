...
//recorriendo el conjunto de resultados con un bucle
        ...
        <td><a href="#" id="abriPoppup<?php echo $i ?>"><?php echo $fila['EstadoActual'] ?></a>
            ...
            <div id="dialog<?php echo $i ?>" title="ACTUALIZACION DEL ESTADO ORDEN DE VERIFICACION" class="contenido">
                <iframe src="formEditarVerificacion.php?iddim_Verificacion=<?php echo $fila['iddim_aseguradoindevido'] ?>" style="width: 100%; height: 90%"></iframe>
            </div>
        </td> 
