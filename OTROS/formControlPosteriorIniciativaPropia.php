...
//$conexion->close()               
                ...
                if ($dni != NULL) {
                    ...
                    <?PHP
                    $queryM = 
                     "SELECT b.idTVerificacionPerfil, b.VerificacionPerfil, b.descripcion
...
//            $dgatpno = null;
            ...
            $queryT = oci_parse($conexionora, "select sc.dgansas, sc.dgacaut,
                                                t.TXT_APEPATERNO,nvl(t.TXT_APEMATERNO,'')as apematerno,nvl(t.TXT_APEMATCASADA,'')as apematcasada,t.TXT_NOMBRES,
