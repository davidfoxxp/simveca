        ...
        <div class="container" id="advanced-search-form">
            ...
            <form name="form" action="" method="POST">   
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="first-name" name="dni" minlength="8" maxlength="8" onKeypress="if (event.keyCode < 45 || event.keyCode > 57)event.returnValue = false;">
                </div>
                <div class="form-group">
...
//liberando los recursos
                ...
                $querydh = oci_parse($conexionora, "select
                                            ...
                                            r.txt_apepaterno ||  ' ' || r.txt_apematerno ||  ' ' || r.txt_apematcasada ||  ' ' || r.txt_nombres as nombres_dh
                                            from dim_SCCMDGAT a 
                                            inner join dim_sccmvtft C     ON a.dgansas = c.VTFNSAS 
                                            inner join dim_sccmdgat D     ON C.VTFNSAF = D.DGANSAS 
                                            inner join dim_csamreniec r   on r.ide_dni=d.dgandid
                                            where a.dgandid='$dni'");
                ...
                while ($row = oci_fetch_array($querydh, OCI_NUM + OCI_RETURN_NULLS)) {
                    ...
                    <div class="form-group">
                        <label for="first-name">SELECCIONE</label>        
                            <input id="i1" type="checkbox" style="text-align: center" name="seleccion[]" onchange="showContentGrado(this)"
                                   value="<?php echo $row[0] ?>,<?php echo $row[4] ?>,<?php echo $row[3] ?>" readonly=""></input>
                    </div>
                    <div class="clearfix"></div>
                    </div>
                    <?php
...
//$conexion->close()               
                ...
                if ($dni != NULL) {
                    ...
                    <div class="form-group">
                        <label for="first-name">TIPO DE VERIFICACION</label>                        
                    ...
                    ?>
                    <div class="form-group">
                        <label for="last-name">ORIGEN DE VERIFICACION</label>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name = "idTEstadoActual" onchange="habilitar11(this.value);" id = "idTEstadoActual">                            
                     ...
                     <div class="form-group has-success has-feedback">
                       <label for="first-name" id="th1">N° ORDEN DE VERIFICACION <br> (000000)</label>                        
                        <input type="text" class="form-control" name="nnorden" id="nnorden" minlength="6" maxlength="6" onKeypress="if (event.keyCode < 45 || event.keyCode > 57)
                                        event.returnValue = false;" required="" autocomplete="off"></input>                        
                    </div>
                     ...
                     <div class="form-group" id="th1">
                        <br><label for="first-name" id="th1">AÑO</label>             
                        <select class="form-control" name = "ano" onchange="habilitar11(this.value);" id = "ano" required>                            
                    ...
                    ?>
                        <label for="last-name">VERIFICADOR</label>
                        <select class="form-control" name="cbx_verificador" id="cbx_verificador" class="con_estilos" required>
                            <option value="">----</option>
                    ...
                    $queryM = "SELECT b.idTVerificacionPerfil, b.VerificacionPerfil, b.descripcion
                                FROM sisgasv.tipoverificacionperfil b 
                                where b.idTVerificacion='2' and not b.idTVerificacionPerfil='31'";
                    $resultado = $conexionmysql->query($queryM);
                    ?>
                    <div class="form-groupppp">
                        <label for="last-name">TIPO DE PERFIL</label>
                        <select class="form-control nombres" name="cbx_perfil" id="cbx_perfil" class="con_estilos" >
                            <option value="">----</option>
                    ...
                    <div class="form-group">
                        <label for="first-name">FECHA DE EMISION DE LA ORDEN DE VERIFICACION</label>
                        <input type="date" class="form-control date" name = "femiordverif" min="0001-01-01" required></input>
                    </div>
                                         
                    <div class="form-grouppp">
                        <label for="first-name">FECHA DEVOLUCION DEL INF FINAL POR JEFE DE OSPE</label>
                        <input type="date" class="form-control date" name = "fdevinffinal" min="0001-01-01"></input> 
                    </div>                        
                     
                     <div class="form-groupp">
                        <label for="first-name">FECHA ENTREGA DEL INF FINAL AL JEFE DE OSPE</label>
                        <input type="date" class="form-control date" name = "fentreinffinal" min="0001-01-01"></input>
                    </div>                  
                                       
                    
                    <div class="form-group">
                        <label for="last-name">FECHA TERMINO PERIODO DE BAJA</label>
                        <input type="date" class="form-control date" name = "fterminoperbaja" min="0001-01-01"></input>
                    </div>     
                    
                      <div class="form-groupp">
                        <label for="last-name">N° RESOLUCION DE BAJA DE OFICIO</label>
                        <input type="text" class="form-control" name = "numresolb" readonly></input>
                    </div>
    
                      <div class="form-groupp">
                        <label for="first-name">FECHA EMISION BAJA DE OFICIO</label>
                        <input type="date" class="form-control date" name = "femibof" min="0001-01-01"></input>
                    </div>
                    
                    <div class="form-groupppp">                       
                        <label for="first-name">ESTADO / RESPUESTA A LA RESOLUCION DE BAJA</label>                    
                        <select class="form-control nombres" name = "idTRRBRegistro" id="idTRRBRegistro" onchange="habilitar33(this.value);">
                    ...
                    <div class="form-groupapp">
                        <label for="last-name">
                        LISTADO DE VERIFICADORES DE LA OSPE/UCF:
                    </label>
                        <div id="td1">
                        <?PHP
...
$array2 = $array[0]. ',' .$array[1]. ',' .$array[2]. ',' .$array[3]. ',' .$array[4]. ',' .$array[5];
...
//                    $numpdf = $numResolucionRegistro00 . $dni_1 . $eempleadora . $codOficina;
                    ...
                    $cod_caso = $dni_2 . "OAREBAGLIATI" . $ano;
                }
...
//                    $numpdf = $numResolucionRegistro00 . $dni_1 . $eempleadora . $codOficina;
                    ...
                    $cod_caso = $dni_2 . "OASABOGAL" . $ano;
                    
//                } else {
////                    $nnnResBRegistro = $numResolucionRegistro00 . "-" . $textoOAS . "-EXGSA-GAAA-CGSPE-ESSALUD" . "-" . $ano;
////                    $numpdf = $numResolucionRegistro00 . $dni_1 . $eempleadora . $codOficina;
//                    
//                    $ordenVV = $unidad . "-" . $ano . "-VCA-" . $nnorden . "-084-001";
//                    $cod_caso = $dni_1 . $eempleadora . $unidad . $ano;
//                
              }
            }
            ...
            ($max, '$idOficinaUsuario', $max,
             ...
             '$dni_2', '$dgacaut', '$apepatreniec', '$apematreniec','$apematcasada', 
            '$nombresreniec', '', '$DGAFNAC', '$departamen', '$provincia', '$distrito', 
            '$direccion',
            $dni_1, $dgacaut_1, $datos_1,'$vinculoauto0',
            $idtusuario, $fecha_hora_creacion)";


           $query1 = "INSERT INTO 
                    dim_overificacion (iddim_Overificacion, idDIM_Oficina, ordenV, 
                    fechaEmision, idTActosverificacion, Observaciones, 
                    idtusuario, fCreacion) 
                    VALUES ($max, '$idOficinaUsuario', '$ordenVV', 
                    $femiordverif, '084', $obsOSPE,
                    $idtusuario, $fecha_hora_creacion)";
            
            $query2 = "INSERT INTO 
                    dim_resboficio (iddim_Overificacion, iddim_ResBOficio, fechaEmiBOficio, 
                     
                    fechaDevInfFinal, 
                    idtusuario, fCreacion) 
                    VALUES ($max, $max, $femibof, 
                     
                    $fdevinffinal, 
                    $idtusuario, $fecha_hora_creacion)";
            
            $query3 = "INSERT INTO dim_actaverificacion 
                    (iddim_ActaVerificacion, idTActosverificacion, iddim_Verificadores1, idTusuario, fCreacion) 
                    VALUES 
                    ($max, '026', $cbx_verificador, $idtusuario, $fecha_hora_creacion)";


            $query5 = "INSERT INTO dim_verificacion (iddim_Verificacion, idTVerificacion, idTVerificacionPerfil, iddim_aseguradoindevido,
                     idTOverificacion, idTEstadoActual,
                      an_verifi, num_verifi,
                     fechaEIFinalJOSPE,
                     nombrePDF, 
                     observaciones, 
                     idtusuario, fCreacion, fCreacionTerminado) VALUES ($max, '2', $idTVerificacionPerfil, $max, 
                     $max, $idTEstadoActual,
                     $ano, '$nnorden',
                     $fentreinffinal,
                     '$cod_caso',
        ...
        $query = "INSERT INTO dim_aseguradoindevido 
            ...
            $query5 = "INSERT INTO dim_verificacion (iddim_Verificacion, idTVerificacion, idTVerificacionPerfil, iddim_aseguradoindevido,
                     ...
                     nombrePDF, 
                     observaciones, 
                     idtusuario, fCreacion) VALUES ($max, '2', $idTVerificacionPerfil, $max, 
                     $max, $idTEstadoActual,
                     $ano, '$nnorden',
                     $fentreinffinal,
                     '$cod_caso',
