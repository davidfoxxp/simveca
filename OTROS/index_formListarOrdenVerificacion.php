                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4>FORMULARIO CONTROL POSTERIOR</h4>
                        </div>
                            ...
                            <div id="div1" align="center">  
                                ...
                                <table id="t1" border="1" class="table table-hover table-bordered table-condensed table-striped table-fixed"> 
                                    <tr>
                                        ...
                                        <td><div class="size">INICIO 1º PERIODO A CALIFICAR</div></td>
                                        <td><div class="size">FIN DEL 1º PERIODO A CALIFICAR</div></td>

                                        <td><div class="size">INICIO 2º PERIODO A CALIFICAR</div></td>
                                        <td><div class="size">FIN DEL 2º PERIODO A CALIFICAR</div></td>

                                        <td><div class="size">INICIO 3º PERIODO A CALIFICAR</div></td>
                                        <td><div class="size">FIN DEL 3º PERIODO A CALIFICAR</div></td>                                        

                                        <td><div class="size">INICIO 4º PERIODO A CALIFICAR</div></td>
                                        <td><div class="size">FIN DEL 4º PERIODO A CALIFICAR</div></td>                                        

                                        <td><div class="size">INICIO 5º PERIODO A CALIFICAR</div></td>
                                        <td><div class="size">FIN DEL 5º PERIODO A CALIFICAR</div></td>

                                        <td><div class="size">ESTADO ACTUAL</div></td>

                                        <td><div class="size">PROCESO</div></td>
                                        <td><div class="size">TIPO DE PROCESO</div></td>                                        
                                        <td><div class="size">GENERA BAJA REGISTRO</div></td>                                                                
...
//liberando los recursos
                                ...
                                <input type="submit" name="buscar" value="Exportar" maxlength="11" class="button button2">                
                                    <?php            
                                    }                                     
                                    else {
...
//recorriendo el conjunto de resultados con un bucle
                                                ...
                                                if ($conexionmysql->query($query2)) {
                                                    while ($fila2 = $result2->fetch_assoc()) {
                                                        ...
                                                        <td><?php echo $fila2['EstadoActual'] ?></td>                                                  
...
//recorriendo el conjunto de resultados con un bucle
                                                    ...
                                                    if ($conexionmysql->query($query3)) {
                                                        while ($fila3 = $result3->fetch_assoc()) {
                                                            ...
                                                            <td><?php echo $fila3['InicioPCalificar1'] ?></td>                                
                                                            <td><?php echo $fila3['FinPCalificar1'] ?></td>

                                                            <td><?php echo $fila3['InicioPCalificar2'] ?></td>                                
                                                            <td><?php echo $fila3['FinPCalificar2'] ?></td>

                                                            <td><?php echo $fila3['InicioPCalificar3'] ?></td>                                
                                                            <td><?php echo $fila3['FinPCalificar3'] ?></td>

                                                            <td><?php echo $fila3['InicioPCalificar4'] ?></td>                                
                                                            <td><?php echo $fila3['FinPCalificar4'] ?></td>

                                                            <td><?php echo $fila3['InicioPCalificar5'] ?></td>                                
                                                            <td><?php echo $fila3['FinPCalificar5'] ?></td>

                                                            <td><?php echo $fila3['EstadoActual'] ?> </td>
