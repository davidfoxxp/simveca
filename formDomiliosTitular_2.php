...
<!--                        <th id="td1">                           
                        ...
                        <th id="td1" style="text-align: center">
                            <input id="i1" type="hidden" name="id<?php echo $i ?>" value="<?php echo $fila['iddim_domicilios'] ?>">
                            <input id="i1" type="checkbox" style="text-align: center" value="1" name="chx<?php echo $i ?>" onchange="showContentGrado(this)">
                        </th>
