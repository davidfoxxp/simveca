...
<html lang="en">
        ...
        <script>
            function habilitar_control(value)
            {
                if (value === "1")
                {
                    ...
                    document.getElementById("Nsubfijo").value = "";
    ...
    <body>  
        ...
        <form name="form" action="" method="POST">          
            ...
            INGRESE EL RUC: <input type="number" name='ruc' required>       
                ...
                <LEFT>
                    <TABLE BORDER>
                        ...
                        while ($row = oci_fetch_array($queryT, OCI_NUM + OCI_RETURN_NULLS)) {
                            ...
                            <TR>
                                <TD colspan="2" id="th3"><b>TITULAR:</b></TD>
                            </tr>
                            <tr>
                                <td id="th3">
                                ...
                                <td>
                                    <a href="#" id="abriPoppup1">
                                        ...
                                        <input id="i1" type="HIDDEN" name="tipodoc" value="<?php echo $row[2] ?>" readOnly="readOnly">  
                                        <input id="i1" type="text" name="dni" size="15" value="<?php echo $row[4] ?>" readOnly="readOnly">    
                            ...
                            <tr>
                                ...
                                <td><input id="i1" type="text" name="datos" size="60" value="<?php echo $row[1] ?>" readonly></td>                            
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="i1" type="HIDDEN" name="ubigeo" value="<?php echo $row[5] ?>" readOnly="readOnly">   
                                    <input id="i1" type="text" name="dubigeo" size="60" value="<?php echo $row[6] ?>" readonly>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td id="td1">
                                    <input id="i1" type="text" name="domicilioA" size="70" value="<?php echo $row[7] ?>" readonly>
                                </td>                            
                            </tr>

                            <tr>
                                <TD colspan="2" id="th4"><b>DERECHO HABIENTES</b></TD>
                            </tr>    
                            <?php
                        }
...
//liberando los recursos
                        ...
                        while ($row = oci_fetch_array($querydh, OCI_NUM + OCI_RETURN_NULLS)) {
                            ...
                            <tr>                               
                                ...
                                <td id="td1">
                                    <input id="i1" type="text" name="vinculo" size="60" value="<?php echo $row[0] ?>" readonly>
                                </td>       
                            </tr>
                            ...
                            <tr>
                                ...
                                <td id="td1">
                                    <input id="i1" type="text" size="50" name="DH" value="<?php echo $row[4] ?>" readonly>
                                </td>
                            </tr>
                            <tr>
                                <td id="th4">
                                ...
                                <td id="td1"><input id="i1" type="text" size="50" name="DH" value="<?php echo $row[3] ?>" readonly>                                                      
                                </td>
                            </tr>                              
                        ...
                        if ($ruc != NULL) {
                            ...
                            while ($row = oci_fetch_array($queryemp2, OCI_NUM + OCI_RETURN_NULLS)) {
                                ...
                                ?>  
                                <tr>
                                    <TD colspan="2" id="th2"><b>EMPRESA</b></TD>
                                </tr>                             
                                ...
                                <tr>
                                    ...
                                    <td id="td1">
                                        <input id="i1" type="text" size="50" name="nombreEntidad2" value="<?php echo $row[2] ?>" readonly>
                                    </td>                              
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="1" id="td1">
                                        <a href="#" id="abriPoppup4">
                                            <input id="i1" type="text" name="NUMRUC2" size="15" value="<?php echo $row[1] ?>" readOnly="readOnly"></a> 
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td id="td1">
                                        <input id="i1" type="HIDDEN" name="ubigeoAE2" size="60" value="<?php echo $row[5] ?>" readOnly="readOnly">
                                        <input id="i1" type="text" name="direccionAE2" size="70" value="<?php echo $row[6], ' - ', $row[7] ?>" readOnly="readOnly"></td> 
                                </tr>  
...
//$conexion->close()
                        ...
                        if ($dni != NULL) {
                            ?>
                            <tr>
                                <TD colspan="2" id="th5"><b>REGISTRO POR INICIATIVA PROPIA</b></TD>
                            </tr> 
                            ...
                            <TR>
                                ...
                                <td colspan="1">
                                    ...
                                    <div>
                                        <select  name="cbx_tverificacion" id="cbx_tverificacion" required="" onchange="habilitar_control(this.value);">
                                            <option value="">----</option>
                            ...
                            <tr>
                                <td id="th5" colspan="4">
                                    <B>INICIO NUMERO RESOLUCION BAJA</b>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>        
                                    <input type = "text" name = "Nsubfijo" id="Nsubfijo" minlength="3" maxlength="3"
                                           event.returnValue = false;" value="" required onkeypress="if (event.keyCode < 45 || event.keyCode > 57)
                                                           event.returnValue = false;">
                                </td>
                                <td id="th5">
                                    NUMERACION DEL DOCUMENTO<BR>                                
                                </td>

                                <td><select name = "doc" id="doc" required>
                                        <option value="">---</option>
                            ...
                            <tr>
                                ...
                                <td>        
                                    <input type = "text" name = "numm" minlength="4" maxlength="4" id="numm"
                                           event.returnValue = "false;" required onkeypress="if (event.keyCode < 45 || event.keyCode > 57)
                                                           event.returnValue = false;">
                                </td>
                                <td id="th5">
                                    AÑO
                                </td>                            
                                <td><select name = "ano" id="ano" required>
                                        <option value=""></option>
                            ...
                            <tr>
                                <td id="th5" colspan="4">
                                    <B>FIN NUMERO RESOLUCION BAJA</b>
                                </td>
                            </tr>
                            ...
                            <tr><td id="th5">
                                    FECHA ENVIO DE CARTA A FINANZAS POR RECUPERO DE BAJA
                                </td>
                            ...
                            <tr>
                                ...
                                <td><input type = "text" name = "ncartafinanza" id="ncartafinanza" maxlength="50"><br></TD>
                            </tr> 
                            ...
                            <tr>
                                ...
                                <td><textarea rows = "4" cols = "50" placeholder="Solo 200 caracteres" name = "observaciones" id="observaciones" maxlength="200"></textarea><br>
                                </td>
                            </tr>
                            <tr>
                                <td>
        ...
        <?php
            ...
            felperuano, fweb, fdiario, nombrePDF,
            observaciones,             
            ...
            $fpubPeruano, $fpubweb, $fpubdiario, '$numpdf',
            $obsOSPE,            
