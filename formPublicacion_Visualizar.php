        ...
        <form name="form2" method="POST" action="actualizarPublicacionVisualizacion.php" > 
                    <table>
                        ...
                        <tr>
                            ...
                            <td id="td1" colspan="2" style="width: 100px;text-align: center">
                                <input type="date" min="1990-01-01" name="fechanotiActo" value="<?php echo $fila['fnotificacion'] ?>" readonly/>
                            </TD>                            
                        </tr>
                        <?php } ?>
                        ...
                        <tr>
                            ...
                            <td id="td1" colspan="2" style="width: 100px;text-align: center">
                                <input type="date" min="1990-01-01" name="fechanotiActo2" value="<?php echo $fila['fnotificacion_v'] ?>" readonly/>
                            </TD>                            
                        </tr>
                        <?php } ?>
                    ...
                    <?php } ?>
                        ...
                        <tr>
                            ...
                            <td id="td1" colspan="2" style="width: 100px;text-align: center">
                                <input type="date" min="1990-01-01" name="fechapubliActoW" value="<?php echo $fila['fpublicacion_e'] ?>" readonly/>
                            </TD>    
                        </tr>
                        <?php } ?>
                        ...
                        <tr>
                            ...
                            <td id="td1" colspan="2" style="width: 100px;text-align: center">                                
                                <input type="date" min="1990-01-01" name="fechapubliActoC" value="<?php echo $fila['fpublicacion_c'] ?>" readonly=""/>
                            </TD>    
                        </tr>
                         <?php } ?>
                    ...
                    $queryoficina = "SELECT ai.idDIM_Oficina as idDIM_OficinaII ,pu.fnotificacion, pu.fnotificacion_v,
                        ...
                        FROM dim_verificacion cp 
                        left join dim_publicacion pu on cp.iddim_Verificacion=pu.iddim_Verificacion
                        left join dim_aseguradoindevido ai on cp.iddim_aseguradoindevido=ai.iddim_aseguradoindevido                        
                        where pu.iddim_Publicacion='$iddim_Publicacion' and cp.idTVerificacion='2'";
