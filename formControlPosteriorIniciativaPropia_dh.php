...
//                                                    (select max(t.periodo)-1 from DIM_SGAD_HIS_ADSCRIPCION_LOCAL t)
...
<!--                    <div class="form-group">
                        ...
                        <input type="date" class="form-control date" name = "femisionBRegistro" id="femisionBRegistro" min="0001-01-01" required></input>
                    </div>   -->
                        ...
                        <tr>
                            ...
                            <td>
                             <div class="form-group" style="width: 200px">
                                ...
                                <input type="date" class="form-control date" name = "ffincali" min="1998-01-01" max="<?php $hoy = getdate(); echo $hoy = date("Y-12-31"); ?>" 
                                       id="ffincali" required></input>
                            </div>     
                            </td>
...
//            }
    ...
    if (empty($_POST['finicali'])) {
        ...
        $InicioPFinall = $_POST['finicali'];
        $InicioPFinal = "'$InicioPFinall'";
    }
    if (empty($_POST['ffincali'])) {
        $FinPFinal = 'NULL';
    } else {
        $FinPFinall = $_POST['ffincali'];
    ...
    if ($unidad == 'NULL') { 
         ...
         $numpdf=NULL;
            ...
            '$direccion','$dni_1', $dgacaut_1, $datos_1,'$vinculoauto0',
